Shader "AndreTrainning/Tutorial5MultipleLights" {
	Properties {
	...
	SubShader {
		...
		Pass{ //we duplicate the entire code
		TAGS {"LightMode"="ForwardAdd"	} // Use a different lightmode for the second pass
		Blend One One // the blend modes, it can be : Zero One, One Zero, to turn off one or the other light 
		CGPROGRAM
		//Pragmas
		#pragma vertex vert
		#pragma fragment frag
